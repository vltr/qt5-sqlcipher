...
$cmd = "$cmd`" LTLINKOPTS=`""
$cmd = $cmd + @'
""E:\lib\openssl\1.0.2h\msvc2013-x86-asm-shared-debug\bin"";""E:\lib\openssl\1.0.2h\msvc2013-x86-asm-shared-debug\lib"" ""E:\lib\openssl\1.0.2h\msvc2013-x86-asm-shared-debug\lib\libeay32.lib""" "OPTS=-DSQLITE_HAS_CODEC -DSQLITE_TEMP_STORE=2 -D_USING_V120_SDK71_ -DSQLITE_API=__declspec(dllexport) -IE:\lib\openssl\1.0.2h\msvc2013-x86-asm-shared-debug\include"
'@
...
Rename-Item ".\sqlcipher-$sqlcipher_version" ".\sqlcipher-debug"
